...
class AppDelegate: UIResponder, UIApplicationDelegate, UISplitViewControllerDelegate {
    ...
    func application(application: UIApplication, didFinishLaunchingWithOptions launchOptions: [NSObject: AnyObject]?) -> Bool {
        managedObjectContext = CoreDataStack(docURL: self.applicationDocumentsDirectory,modelURL: NSBundle.mainBundle().URLForResource("iCloudExtensionTest", withExtension: "momd")!).managedObjectContext!
    ...
    lazy var persistentStoreCoordinator: NSPersistentStoreCoordinator? = {
        ...
        let url = self.applicationDocumentsDirectory.URLByAppendingPathComponent("iCloudExtensionTest.sqlite")
