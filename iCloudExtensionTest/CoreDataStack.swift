...
class CoreDataStack{
    ...
    init(docURL: NSURL,modelURL: NSURL) {
        self.applicationDocumentsDirectory = docURL
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        return NSManagedObjectModel(contentsOfURL: self.managedObjectModelURL)
        }()
     ...
     lazy private var persistentStoreCoordinator: NSPersistentStoreCoordinator? = {
        ...
        //let theUrl = self.applicationDocumentsDirectory.URLByAppendingPathComponent("iCloudExtensionTest.sqlite")
